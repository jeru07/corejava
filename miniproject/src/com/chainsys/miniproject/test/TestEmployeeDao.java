...
public static void testInsertEmployee() {
	...
	newemp.setEmp_id(303);
	newemp.setFirst_name("jeru");
	newemp.setLast_name("ciana");
	newemp.setEmail("jeru@mail.com");
...
public static void testUpdateEmployee() {
	...
	oldEmployee.setFirst_name("rithu");
	oldEmployee.setLast_name("Joe");
	oldEmployee.setEmail("rithu@mail.com");
	Calendar c1 = Calendar.getInstance();
	java.util.Date newDate =c1.getTime();
