...
protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	  ...
	  /*	currentSession.setMaxInactiveInterval(0); //no time out period if value is zero or less than zero(infinite)
	 	currentSession.setMaxInactiveInterval(5*60); // 5-minutes 60-sec 
