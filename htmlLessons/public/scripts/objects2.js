...
myobject.x = 200;
console.log('Data: ' + myobject.data);// calling to getData()
console.log('x: ' + myobject.x);
myobject.data = 100; //calling to setData()
...
class RegisterNumber {
  ...
  constructor() {
    this.#number = 1;
  }//# is legal inside javascript class but illegal in javascript object
  getNumber(){ return this.#number;}
  #printToScreen(){ return this.#number;} //private method
  callPrint() 
{
	const x= this.#printToScreen(); //calls private function within the same class
	return x ;}
}
